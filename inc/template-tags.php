...
function emphaino_content_nav( $nav_id ) {
	...
	<?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>
		...
		<div class="nav-previous"><?php next_posts_link( __( 'More <span class="meta-nav">&rarr;</span>', 'emphaino' ) ); ?><!--<?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'emphaino' ) ); ?>--></div>
		<?php endif; ?>

		<?php if ( get_previous_posts_link() ) : ?>
		<div class="nav-next"><?php previous_posts_link( __( '<span class="meta-nav">&larr;</span> Back', 'emphaino' ) ); ?><!--<?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'emphaino' ) ); ?>--></div>
		<?php endif; ?>
